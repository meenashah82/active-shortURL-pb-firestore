...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-electric-violet text-white py-3 px-4">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-tundora mb-4">Make Short URL</h1>
            <p className="text-lg text-tundora mb-8">
            ...
            <div className="flex justify-center gap-4">
              <Link href="/dashboard">
                <Button
                  variant="outline"
                  className="border-light-purple text-tundora hover:bg-light-purple bg-white font-medium"
                >
              ...
              <Link href="/admin">
                <Button className="bg-violet-pink hover:bg-violet-pink/90 text-white font-medium">
